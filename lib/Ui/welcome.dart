...
import 'package:weathersapp/Ui/home.dart';
import 'package:weathersapp/model/city.dart';
            ...
            child: Row(
              children: [
                GestureDetector(
                    ...
                    child: Image.asset(cities[index].isSelected == true ? 'assets/checked.png' : 'assets/uncheck.png', width: 30,)),
